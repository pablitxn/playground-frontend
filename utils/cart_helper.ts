...
export const getCartIds = (cartItems: any): string => {
...
export const stringifyArr = (cartItems: any): string => {
	return cartItems
		.map((item: any) => {
...
export const saveToCartCookie = (cartItems: any) => {
...
export const getCartCookieArr = (): any => {
...
export const getItemIndex = (cartItems: any, id: string) => {
	return cartItems.map((item) => item.id).indexOf(id);
};

export const removeItem = (cartItems: any, id: string) => {
